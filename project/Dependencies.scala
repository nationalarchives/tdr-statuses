...
object Dependencies {
  ...
  private val awsVersion = "2.40.13"
  ...
  lazy val backendCheckUtils = "uk.gov.nationalarchives" %% "tdr-backend-checks-utils" % "0.1.157"
  ...
  lazy val catsTesting = "org.typelevel" %% "cats-effect-testing-scalatest" % "1.7.0"
