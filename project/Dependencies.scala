...
object Dependencies {
  ...
  private val awsVersion = "2.42.38"
  ...
  lazy val snsUtils = "uk.gov.nationalarchives" %% "sns-utils" % "0.1.327"
  lazy val backendCheckUtils = "uk.gov.nationalarchives" %% "tdr-backend-checks-utils" % "0.1.195"
