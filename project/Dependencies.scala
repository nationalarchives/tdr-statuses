...
object Dependencies {
  ...
  private val awsVersion = "2.42.34"
  ...
  lazy val snsUtils = "uk.gov.nationalarchives" %% "sns-utils" % "0.1.325"
  lazy val backendCheckUtils = "uk.gov.nationalarchives" %% "tdr-backend-checks-utils" % "0.1.194"
