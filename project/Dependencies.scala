...
object Dependencies {
  ...
  private val awsVersion = "2.41.29"
  private val doobieVersion = "1.0.0-RC11"

  lazy val awsS3 = "software.amazon.awssdk" % "s3" % awsVersion
  lazy val backendCheckUtils = "uk.gov.nationalarchives" %% "tdr-backend-checks-utils" % "0.1.183"
  ...
  lazy val metadataSchema =  "uk.gov.nationalarchives" %% "da-metadata-schema" % "0.0.117"
