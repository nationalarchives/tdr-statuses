...
object Dependencies {
  ...
  private val awsVersion = "2.44.14"
  ...
  lazy val snsUtils = "uk.gov.nationalarchives" %% "sns-utils" % "0.1.331"
  lazy val backendCheckUtils = "uk.gov.nationalarchives" %% "tdr-backend-checks-utils" % "0.1.214"
