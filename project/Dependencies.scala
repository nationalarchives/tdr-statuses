...
object Dependencies {
  ...
  private val awsVersion = "2.46.21"
  ...
  lazy val metadataSchema =  "uk.gov.nationalarchives" %% "da-metadata-schema" % "0.0.136"
  ...
  lazy val objectKeyContext = "uk.gov.nationalarchives" %% "tdr-object-key-context" % "0.0.36"
